...
public class General {
	...
	/**
	 * A method for testing the algorithm passing data sets found online
	 * 
	 * @param evaluations
	 * @param mutationRate
	...
	public static void Test() throws FileNotFoundException, IOException {
		...
		System.out.println("Knapsacks: " + knapsacks + " | Total N¼ Items: "
				+ n + " ------->>");
		...
		Gen gen = new Gen(values, costs, constraints, knapsacks, mutationRate,
				populationSize, tournamentSize, evaluations);
	...
	/**
	 * A Test to run different batches of problems with cost and values
	...
	public static void randomTest() throws FileNotFoundException, IOException {
		...
		for (int i = 0; i < batches; ++i) {
			...
			System.out.println("Knapsacks: " + knapsacks
					+ " | Total N¼ Items: " + n + " ------->>");
			...
			/* Create Genetic object */
			Gen gen = new Gen(values, costs, constraints, knapsacks,
					mutationRate, populationSize, tournamentSize, evaluations);
